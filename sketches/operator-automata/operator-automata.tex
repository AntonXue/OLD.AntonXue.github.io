...
\begin{definition}[Square Operator Permutation]
...
First, we need a way to generalize this to cases where
\(A\) and \(B\) are not the same dimension.
Second, we need to make sure that this still indeed defines a metric.
