...
we are interested in extending the definition to more
general \(n\)-string spaces.
General product metrics can be defined with respect to the
\(n\)-dimensional Euclidean norm,
\red{but we possibly want something more custom}.
